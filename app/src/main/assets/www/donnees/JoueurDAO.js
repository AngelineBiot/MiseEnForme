    ...
    this.initialiser = function()
    {
        ...
        this.baseDeDonnees.transaction(
            function(operation)
            {
                ...
                var SQL_SELECT_CREATE_DESSIN = "CREATE TABLE IF NOT EXISTS Dessin(idDESSIN INTEGER PRIMARY KEY AUTOINCREMENT, idJOUEUR INTEGER, nbFormesDESSIN INTEGER, cheminDESSIN VARCHAR(MAX))";
